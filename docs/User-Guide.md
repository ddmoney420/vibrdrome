...
- **AirPlay**: Use the AirPlay button in the player toolbar (or Control Center) to send audio to AirPlay speakers, an Apple TV, or a TV — individually or as a multi-room group.

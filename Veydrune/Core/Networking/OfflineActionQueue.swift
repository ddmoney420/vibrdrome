...
private let offlineLog = Logger(subsystem: "com.veydrune.app", category: "OfflineQueue")
...
final class OfflineActionQueue {
    ...
    private func startMonitor() {
        ...
        networkMonitor.start(queue: DispatchQueue(label: "com.veydrune.offlinequeue"))
    }
